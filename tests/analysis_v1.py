# This class can be used to plot the different fields of the flight data from
# before the implementation of the Kalman filter, and the restructuring of the
# flight packets.
